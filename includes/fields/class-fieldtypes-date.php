...
class WPBDP_FieldTypes_Date extends WPBDP_FieldTypes_TextField {
	...
	public function render_field_settings( &$field = null, $association = null ) {
		...
		$settings = array(
			'date_format' => array(
				_x( 'Date Format', 'form-fields api', 'business-directory-plugin' ),
				$select,
			),
		);
	...
	private function get_formats() {
		...
		$formats['dd/mm/yy'] = array(
			'date_format'       => 'd/m/y',
			'datepicker_format' => 'dd/mm/y',
		);
		$formats['dd.mm.yy'] = array(
			'date_format'       => 'd.m.y',
			'datepicker_format' => 'dd.mm.y',
		...
		$formats['mm/dd/yy']   = array(
			'date_format'       => 'm/d/y',
			'datepicker_format' => 'mm/dd/y',
		);
		$formats['mm/dd/yyyy'] = array(
			'date_format'       => 'm/d/Y',
