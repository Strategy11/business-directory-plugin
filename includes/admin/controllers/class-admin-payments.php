...
class WPBDP__Admin__Payments extends WPBDP__Admin__Controller {
	...
	function index() {
		...
		if ( 'payment_delete' === wpbdp_get_var( array( 'param' => 'message' ) ) ) {
			wpbdp_admin_message( _x( 'Payment deleted.', 'payments admin', 'business-directory-plugin' ), 'wpbdp-show-notice-once' );
		}
	...
	public function details() {
		if ( 1 == wpbdp_get_var( array( 'param' => 'message' ) ) ) {
			wpbdp_admin_message( _x( 'Payment details updated.', 'payments admin', 'business-directory-plugin' ), 'wpbdp-show-notice-once' );
		}
