...
class WPBDP_SMTP_Controller {
	...
	protected function output_section_heading() {
		...
		<section class="top">
			...
			<p><?php esc_html_e( 'WP Mail SMTP allows you to easily set up WordPress to use a trusted provider to reliably send emails, including listing notifications.', 'business-directory-plugin' ); ?></p>
		</section>
		<?php
	}
