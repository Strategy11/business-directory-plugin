...
class WPBDP__CPT_Integration {
	...
	public static function menu_icon( $atts = array() ) {
		...
		$icon = '<svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="address-card" ' .
			'class="svg-inline--fa fa-address-card fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" ' .
			'viewBox="0 0 576 512" width="' . esc_attr( $atts['width'] ) . '" height="' . esc_attr( $atts['height'] ) . '" >
            <path fill="' . $atts['fill'] . '" ' .
