<?php
require_once ( WPBDP_INC . 'compatibility/deprecated.php' );
...
class WPBDP_Compat {
    ...
    function __construct() {
        ...
        if ( wpbdp_get_option( 'disable-cpt' ) ) {
            require_once( WPBDP_INC . 'compatibility/class-cpt-compat-mode.php' );
            $nocpt = new WPBDP__CPT_Compat_Mode();
        } else {
            require_once( WPBDP_INC . 'compatibility/class-themes-compat.php' );
    ...
    function load_integrations() {
        if ( isset( $GLOBALS['sitepress'] ) ) {
            require_once( WPBDP_INC . 'compatibility/class-wpml-compat.php' );
            $wpml_integration = new WPBDP_WPML_Compat();
        }

        if ( function_exists( 'bcn_display' ) ) {
            require_once( WPBDP_INC . 'compatibility/class-navxt-integration.php' );
