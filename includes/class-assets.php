...
class WPBDP__Assets {
	...
	public function enqueue_admin_scripts( $force = false ) {
		...
		wp_register_script( 'wpbdp-admin-layout-js', WPBDP_ASSETS_URL . 'js/admin-layout.min.js', array( 'jquery' ), WPBDP_VERSION, true );

		wp_enqueue_script( 'wpbdp-admin-js', WPBDP_ASSETS_URL . 'js/admin.min.js', array( 'jquery', 'thickbox', 'jquery-ui-sortable', 'jquery-ui-dialog', 'jquery-ui-tooltip', 'wpbdp-admin-layout-js' ), WPBDP_VERSION, true );
