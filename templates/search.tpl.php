    ...
    <div class="search-filter <?php echo $field->type; ?>">
        ...
        <div class="field">
            ...
            <?php foreach ($options as $option): ?>
                ...
                <?php else: ?>
                    <label>
                        <input type="checkbox" name="_m[<?php echo $field->id; ?>][options][]" value="<?php echo $option; ?>" <?php echo (isset($post_values['options']) && in_array($option, $post_values['options'])) ? ' checked="checked"' : ''; ?>/> <?php echo $option; ?>
                    </label> <br />
                <?php endif; ?>
            <?php endforeach; ?>
