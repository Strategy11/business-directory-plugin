...
<!-- Removed the ability to set a listing as "Featured" in "info" metabox for 5.1.6 according to instructions on issue #3413 -->
    ...
    <ul class="wpbdp-listing-metabox-renewal-actions">
        ...
        <li>
            <a href="<?php echo esc_url( add_query_arg( 'wpbdmaction', 'renewlisting' ), get_edit_post_link( $listing->get_id() ) ); ?>" class="wpbdp-button-primary button button-small"><?php _ex( 'Renew listing', 'admin infometabox', 'business-directory-plugin' ); ?></a>
        </li>
        <?php endif; ?>
    </ul>
</div>
