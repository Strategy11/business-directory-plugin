...
<!--<?php if (wpbdp_user_can('delete', $listing_id)): ?><form action="<?php echo wpbdp_url( 'delete_listing', $listing_id ); ?>" method="POST"><input type="submit" name="" value="<?php _ex('Delete', 'templates', 'WPBDM'); ?>" class="delete-listing" data-confirmation-message="<?php _ex('Are you sure you wish to delete this listing?', 'templates', 'WPBDM'); ?>" /></form><?php endif; ?>-->
<?php endif; ?>
</div>
