...
class CreateDateFieldCest {
	...
	public function tryToTestCreateField( AcceptanceTester $I ) {
		$I->wantTo( 'Test creating a date field' );
		...
		$I->selectOption( 'form input[name=field[field_type]]', 'date' );
		$I->fillField( 'field[label]', 'Sample Date Field' );
		$I->click( 'Add Field' );
		$I->see( 'Form fields updated.', 'p' );
		$I->see( 'Sample Date Field', 'a' ); // Field link.
	}
}
