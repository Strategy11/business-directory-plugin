...
<form class="wpbdp-form" action="" method="post">
    ...
    <div class="wpbdp-form-row wpbdp-form-textfield">
        <label for="wpbdp-listing-email"><?php _ex( 'Enter your e-mail address', 'send-access-keys', 'WPBDM' ); ?></label>
        <input type="text" name="email" id="wpbdp-listing-email">
    </div>

    <p><input class="submit" type="submit" value="<?php _ex( 'Continue', 'send-access-keys', 'WPBDM' ); ?>" /></p>
</form>
