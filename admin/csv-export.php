...
class WPBDP_Admin_CSVExport {
    ...
    public function enqueue_scripts() {
        ...
        wp_enqueue_script( 'wpbdp-admin-export-js', WPBDP_URL . 'admin/js/export.min.js', array( 'wpbdp-admin-js', 'jquery-ui-dialog' ) );
        wp_enqueue_style( 'wpbdp-admin-export-css', WPBDP_URL . 'admin/css/export.min.css', array( 'wp-jquery-ui-dialog' ) );
    }
